...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.5 on Thu Jul 27 15:21:35 2023
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu.Append(wx.ID_ANY, "Version", "")
        ...
        FileNameLabel = wx.StaticText(self.panel_1, wx.ID_ANY, u"(未選檔案)")
        sizer_2.Add(FileNameLabel, 8, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 10)
        ...
        sizer_4.Add(self.StartButton, 2, wx.ALL, 10)

        LabelB2_null = wx.StaticText(self.panel_1, wx.ID_ANY, "")
        sizer_4.Add(LabelB2_null, 8, wx.ALIGN_CENTER_VERTICAL, 10)
        ...
        self.StatusText = wx.TextCtrl(self.panel_1, wx.ID_ANY, "")
        sizer_6.Add(self.StatusText, 8, wx.ALIGN_CENTER_VERTICAL | wx.ALL, 10)
